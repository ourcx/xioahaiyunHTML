...
// // 使用计算属性获取消息列表
// const message = computed(() => chatStore.privateCon)
// privateCon.value = message.value

// const messageMy = computed(() => chatStore.privateMy)
// privateMy.value = messageMy.value
